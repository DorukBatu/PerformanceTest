...
/*Correlation comment - Do not change!  Original value='sYl_WcSpIoaUaP7RoYgM' Name ='ei' Type ='ResponseBased'*/
	...
	web_url("gen_204",
		"URL=https://www.google.com.tr/gen_204?s=webhp&atyp=csi&ei={ei}&imc=1&imn=1&imp=0&adh=&ima=0&ime=0&rt=xjsls.468,prt.574,iml.574,dcl.575,xjses.3270,xjsee.3506,xjs.3506,ol.4041,aft.574,wsrt.3462,cst.1771,dnst.0,rqst.829,rspt.426,sslt.1627,rqstt.2960,unt.745,cstt.1188,dit.4036&mem=ujhs.12,tjhs.16,jhsl.2190",
		"Resource=0",
		"RecContentType=text/html",
